...
\begin{figure}
\includegraphics[width=350px]{Weather Dashboard} \caption{Example of a what our sidebar menu and dashboard looks like}\label{fig:unnamed-chunk-2}
\end{figure}
...
\footnote{Fig 3. Example of a Highcharter graph that shows temperature}
