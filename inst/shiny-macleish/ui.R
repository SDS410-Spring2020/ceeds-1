              ...
              dashboardBody(
                ...
                tabItems(
                  ...
                  tabItem(tabName = "dictionary", 
                          h1("Description of Variables", align = "center", 
                             style = "font-family: Geneva"),
                          hr(),
                          p("1. WhatelyMet Station"),
                          p("- Timestamp: Timestamp in year/month/day and hour/minutes/seconds."),
                          p("- Temp_C_Avg: Air temperature in degrees Celsius averaged over 10 mins."),
                          p("- WSpd_mps: Wind speed in meters per second averaged over 10 mins."),
                          p("- Wdir_deg: Wind Direction in degrees (0 to 360) averaged over 10 mins."),
                          p("- RH_per_Avg: Relative Humidity measured as a percent averaged over 10 mins."),
                          p("- Press_mb_Avg: barometric Pressure in millibars averaged over 10 mins."),
                          p("- SirW_Avg: Irradiance or flux density as watts per meter"),
                          p("- Rain_mm_Tot: a sum of all precipitation in millimeters over 10 mins."),
                          p("2. Orchardmet Station"),
                          p("- Timestamp: Timestamp in year/month/day and hour/minutes/seconds"),
                          p("- Temp_C_Avg: Air temperature in degrees Celsius averaged over 10 mins."),
                          p("- WSpd_mps: Wind speed in meters per second averaged over 10 mins."),
                          p("- Wdir_deg: Wind Direction in degrees (0 to 360) averaged over 10 mins."),
                          p("- RH_per_Avg: Relative Humidity measured as a percent averaged over 10 mins."),
                          p("- Press_mb_Avg: barometric Pressure in millibars averaged over 10 mins."),
                          p("- PAR_Den_Avg: photosynthetically active radiation as the average density"),
                          p("- PAR_Tot_Avg: photosynthetically active radiation as the average total for 10 mins."),
                          p("- Rain_mm_Tot: a sum of all precipitation in millimeters over 10 mins.")),
