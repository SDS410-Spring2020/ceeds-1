...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      id = "tabs",
      #creating menu items
      menuItem("Current Weather", tabName = "current", icon = icon("seedling")),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      gradientBox(
        ...
        h1(current_o$temperature, "°C"),
        h4("humidity  ", icon("tint"), br(),
           current_o$rel_humidity, "%", align = "right"), hr(style = "width: 40%", align = "right"),
        h4("pressure  ", icon("plane-departure"), br(),
           current_o$pressure, align = "right"), hr(style = "width: 40%", align = "right"),
        h4("precipitation ", icon("umbrella"), br(),
           current_o$rainfall, "mm", align = "right"), hr(style = "width: 40%", align = "right"),
        h4("wind", icon("cloud"), br(),
           current_o$wind_speed, "m/s", align = "right"),
        collapsible = FALSE
      ),
      gradientBox(
        title = "WhatelyMet Station",
        icon = "fa fa-leaf",
        gradientColor = "teal", 
        boxToolSize = "sm",
        footer =
        ...
        h1(current_w$temperature, "°C"),
        h4("humidity  ", icon("tint"), br(),
           current_w$rel_humidity, "%", align = "right"), hr(style = "width:40%", align = "right"),
        h4("pressure  ", icon("plane-departure"), br(),
           current_w$pressure, align = "right"), hr(style = "width:40%", align = "right"),
        h4("precipitation ", icon("umbrella"), br(),
           current_w$rainfall, "mm", align = "right"), hr(style = "width:40%", align = "right"),
        h4("wind", icon("cloud"), br(),
