    ...
    tabItems(
      ...
      tabItem(tabName = "historic", h2("Historic Data", align = "center"),
            fluidPage(
              ...
              h4("precipitation", align = "center"),
              box(highchartOutput("hc2"), width = 12,collapsible = T),
              h4("MAX Wind Speed", align = "center",collapsible = T),
              box(highchartOutput("hc3"),width = 12,collapsible = T),
              h4("Temperature", align = "center"),
              box(highchartOutput("hc1"),width = 12,collapsible = T),
              h4("Wind Direction", align = "center"),
              box(plotlyOutput("hc4"), width = 12,collapsible = T))),
