    ...
    tabItems(
      ...
      tabItem(tabName = "about", 
              ...
              p("Here you will find current weather, historical data (from 
                 ...
                 College.", align = "center", style = "font-family: 'Geneva'; 
                 margin-left: 28%; margin-right: 28%"),
              img(src=b66, height = 326, width = 372, 
              ...
              p("Weather measurements are made at two locations at the MacLeish
                 ...
                 clearing.", style = "font-family: 'Geneva'"),
              br(),
              ...
              p("All the data visualizations you see are interactive so feel 
                ...
                style = "font-family: 'Geneva'; font-si50pt"),
              p("Sincerely,", style = "font-family: 'Geneva'"),
              p("Marta, Mirella, and Julia (SDS 410, spring 2019)", 
                style = "font-family: 'Geneva'; font-si50pt"),
              p("Paul R. Wetzel", style = "font-family: 'Geneva'; font-si50pt",
                a("pwetzel@smith.edu"))),
