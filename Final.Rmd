  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "historic", h2("Historic Data", align = "center"),
          ...
          collapsed =T,title = "Other Variables", sidebarPanel(
    ...
    selectInput('ycol', 'Y Variable', names(ceeds::get_daily(whately_2015))),
      ...
      tabItem(tabName = "raw", h2("Raw data", align = "center"),
          fluidPage(
              box(
                selectInput("dataset", "Dataset", c("WhatelyMet", "OrchardMet")), uiOutput("choose_columns"),
                conditionalPanel( condition = "output.nrows",
                                  checkboxInput("headonly", "Only use first 1000 rows"),
                                  downloadButton('downloadData', 'Download')),width = 12), 
                box(tableOutput("data_table"), width = 30,collapsible = T,
